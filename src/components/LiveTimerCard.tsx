...
export function LiveTimerCard({ activeSession }: LiveTimerCardProps) {
  ...
  return (
    <aside className="rounded-[28px] border border-white/60 bg-white/75 p-6 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.45)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/70">
      <div className="space-y-6">
        ...
        <div className="rounded-[24px] border border-slate-200/70 bg-slate-950 px-6 py-8 text-center shadow-inner dark:border-white/10 dark:bg-slate-950">
          <p className="text-sm font-medium uppercase tracking-[0.22em] text-sky-300">
            Elapsed
          </p>
          <p className="mt-4 font-['Space_Grotesk',_'Segoe_UI',_sans-serif] text-5xl font-semibold tracking-tight text-white sm:text-6xl">
